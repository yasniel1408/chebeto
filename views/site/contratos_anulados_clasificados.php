...
Highcharts.chart('containerr', {
    ...
    title: {
        text: 'Tipos de Contratos clasificados anulados por Reparto'
    },
    xAxis: {
...
Highcharts.chart('containerm', {
    ...
    title: {
        text: 'Tipos de Contratos clasificados anulados por Municipios'
    },
    xAxis: {
...
Highcharts.chart('containerp', {
    ...
    title: {
        text: 'Tipos de Contratos clasificados anulados por Provincias'
    },
    xAxis: {
